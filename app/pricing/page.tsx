...
const t: Record<Language, {
  ...
  pro_title: string; pro_price_ldp: string; pro_per_ldp: string; pro_price_cloud: string; pro_per_cloud: string;
  ...
  ar: {
    ...
    pro_title: '\u0627\u062d\u062a\u0631\u0627\u0641\u064a', pro_price_ldp: '\$2', pro_per_ldp: '/ \u0645\u0632\u0631\u0639\u0629 / \u0634\u0647\u0631\u064a\u0627\u064b (LDPlayer)', pro_price_cloud: '\$3', pro_per_cloud: '/ \u0645\u0632\u0631\u0639\u0629 / \u0634\u0647\u0631\u064a\u0627\u064b (☁️)',
  ...
  en: {
    ...
    pro_title: 'Pro', pro_price_ldp: '\$2', pro_per_ldp: '/ farm / month (LDPlayer)', pro_price_cloud: '\$3', pro_per_cloud: '/ farm / month (☁️)',
    pro_f1: '\u2713 Unlimited farms', pro_f2: '\u2713 All 52 tasks', pro_f3: '\u2713 Advanced ban protection',
  ...
  ru: {
    ...
    pro_title: '\u041f\u0440\u043e', pro_price_ldp: '\$2', pro_per_ldp: '/ \u0444\u0435\u0440\u043c\u0430 / \u043c\u0435\u0441\u044f\u0446 (LDPlayer)', pro_price_cloud: '\$3', pro_per_cloud: '/ \u0444\u0435\u0440\u043c\u0430 / \u043c\u0435\u0441\u044f\u0446 (☁️)',
  ...
  zh: {
    ...
    pro_title: '\u4e13\u4e1a\u7248', pro_price_ldp: '\$2', pro_per_ldp: '/ \u519c\u573a / \u6708 (LDPlayer)', pro_price_cloud: '\$3', pro_per_cloud: '/ \u519c\u573a / \u6708 (☁️)',
      ...
      <div style={{ maxWidth: '750px', margin: '0 auto', textAlign: 'center' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '24px' }}>
          ...
          <div style={{ background: 'linear-gradient(160deg, rgba(124,58,237,0.15), rgba(168,85,247,0.08))', border: '2px solid rgba(124,58,237,0.4)', borderRadius: '20px', padding: '40px 32px', textAlign: 'center', position: 'relative', boxShadow: '0 8px 40px rgba(124,58,237,0.15)' }}>
            ...
            <div style={{ margin: '20px 0' }}><div style={{ marginBottom: '12px' }}><span style={{ fontSize: '40px', fontWeight: 900, color: '#fff' }}>{s.pro_price_ldp}</span><span style={{ fontSize: '13px', color: 'rgba(255,255,255,0.4)', marginInlineStart: '8px' }}>{s.pro_per_ldp}</span></div><div style={{ paddingTop: '12px', borderTop: '1px solid rgba(255,255,255,0.08)' }}><span style={{ fontSize: '32px', fontWeight: 800, color: '#a78bfa' }}>{s.pro_price_cloud}</span><span style={{ fontSize: '13px', color: 'rgba(255,255,255,0.4)', marginInlineStart: '8px' }}>{s.pro_per_cloud}</span></div></div>
            <div style={{ display: 'flex', flexDirection: 'column', gap: '12px', marginBottom: '32px', textAlign: isRtl ? 'right' : 'left' }}>
