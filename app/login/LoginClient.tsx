...
const t: Record<Language, Record<string, string>> = {
  ar: { title: '\u062a\u0633\u062c\u064a\u0644 \u062f\u062e\u0648\u0644', email: '\u0627\u0644\u0628\u0631\u064a\u062f \u0627\u0644\u0625\u0644\u0643\u062a\u0631\u0648\u0646\u064a', password: '\u0643\u0644\u0645\u0629 \u0627\u0644\u0645\u0631\u0648\u0631', btn: '\u062f\u062e\u0648\u0644', loading: '\u062c\u0627\u0631\u064a \u0627\u0644\u062f\u062e\u0648\u0644...', new_user: '\u062c\u062f\u064a\u062f\u061f', create: '\u0625\u0646\u0634\u0627\u0621 \u062d\u0633\u0627\u0628', admin: '\u0645\u0634\u0631\u0641\u061f', admin_login: '\u062f\u062e\u0648\u0644 \u0627\u0644\u0645\u0634\u0631\u0641', forgot: '\u0646\u0633\u064a\u062a \u0643\u0644\u0645\u0629 \u0627\u0644\u0645\u0631\u0648\u0631\u061f' },
  en: { title: 'Login', email: 'Email', password: 'Password', btn: 'Login', loading: 'Signing in...', new_user: 'New?', create: 'Create account', admin: 'Admin?', admin_login: 'Admin Login', forgot: 'Forgot password?' },
  ru: { title: '\u0412\u0445\u043e\u0434', email: '\u042d\u043b. \u043f\u043e\u0447\u0442\u0430', password: '\u041f\u0430\u0440\u043e\u043b\u044c', btn: '\u0412\u043e\u0439\u0442\u0438', loading: '\u0412\u0445\u043e\u0434...', new_user: '\u041d\u043e\u0432\u044b\u0439?', create: '\u0421\u043e\u0437\u0434\u0430\u0442\u044c \u0430\u043a\u043a\u0430\u0443\u043d\u0442', admin: '\u0410\u0434\u043c\u0438\u043d?', admin_login: '\u0412\u0445\u043e\u0434 \u0430\u0434\u043c\u0438\u043d\u0430', forgot: '\u0417\u0430\u0431\u044b\u043b\u0438 \u043f\u0430\u0440\u043e\u043b\u044c?' },
  zh: { title: '\u767b\u5f55', email: '\u90ae\u7bb1', password: '\u5bc6\u7801', btn: '\u767b\u5f55', loading: '\u767b\u5f55\u4e2d...', new_user: '\u65b0\u7528\u6237\uff1f', create: '\u521b\u5efa\u8d26\u53f7', admin: '\u7ba1\u7406\u5458\uff1f', admin_login: '\u7ba1\u7406\u5458\u767b\u5f55', forgot: '\u5fd8\u8bb0\u5bc6\u7801\uff1f' },
}
      ...
      <div style={{ width: '100%', maxWidth: 420, background: '#fff', borderRadius: 16, padding: 36, boxShadow: '0 4px 24px rgba(0,0,0,0.08)' }}>
        ...
        <form onSubmit={onSubmit} style={{ display: 'grid', gap: 14 }}>
          ...
          <div style={{ textAlign: isRtl ? 'left' : 'right' }}>
            <a href="/forgot-password" style={{ color: '#7c3aed', fontSize: 13, textDecoration: 'none' }}>{s.forgot}</a>
          </div>
